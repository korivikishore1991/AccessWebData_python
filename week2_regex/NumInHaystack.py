# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 22:18:42 2015
...
Actual data: http://python-data.dr-chuck.net/regex_sum_217957.txt 
(There are 88 values and the sum ends with 722)
...
a distinct data file for the assignment - so only use your own data file for 
analysis.
...
#f = open ('regex_sum_42.txt') # sample text
f = open ('regex_sum_217957.txt') # actual text
sum = []
for line in f:
    line = line.rstrip()
...
tally = map(int,sum)
answer = reduce(lambda a,b: a+b, tally)
print answer
# 453722
